...
\begin{itemize}
	...
	\item Fabric – defines material of the clothes. For instance wool, cotton, synthetic and etc. All those material types have different sensitive criterion's. Comparing wool and synthetic of the same color and temperature we should take in to account that wool is higher priority clothe and same synthetic clothe should be washed regarding rules of wool.
...
\newpage
Current state of the sorting is represented by table where all values mutate during sort. Quantity of incoming clothes set bin ids and total bin utilization (TBU). TBU - how many times need to be washed it calculated by 8.1 formula:
