...
* Copyright (C) 1998-2007 Jacques Ferber, Olivier Gutknecht
*
...
class AboutBox extends JDialog
{
  ...
  public AboutBox()
  {
    ...
    mld.add("TurtleKit 2.1");
    mld.add("- a MAS simulator for complex systems -");
    mld.add("");
    mld.add("by F. Michel, G. Beurier");
    mld.add("(c) 2007-2009");

    mld.add("");
    mld.add("TurtleKit version: 2.1 beta");
    mld.add("running on:");
