 ...
 */
            ...
            /**
            *  SetDeviceLevel bean class
            */
        
        public  class SetDeviceLevel
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected org.apache.axis2.databinding.types.UnsignedByte localLevel ;
                           ...
                           */
                           public  org.apache.axis2.databinding.types.UnsignedByte getLevel(){
                               return localLevel;
                           }
                            ...
                            /**
                               ...
                               * @param param Level
                               */
                               public void setLevel(org.apache.axis2.databinding.types.UnsignedByte param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       SetDeviceLevel.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SetDeviceLevel",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SetDeviceLevel",
    ...
    public static class Factory{
        ...
        */
        public static SetDeviceLevel parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetDeviceLevel object =
                new SetDeviceLevel();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SetDeviceLevel".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetDeviceLevel)_1._0._0._127.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
