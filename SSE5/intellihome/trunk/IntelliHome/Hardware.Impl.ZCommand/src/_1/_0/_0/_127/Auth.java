                            ...
                            /**
                               ...
                               */
                               public void setCulture(java.lang.String param){
                                       ...
                                       if (param != null){
                                          //update the setting tracker
                                          localCultureTracker = true;
                                       } else {
                                          localCultureTracker = false;
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Auth.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"Culture", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"Culture");
                                        }
                                        ...
                                        xmlWriter.writeStartElement("Culture");
                                          ...
                                          if (localCulture==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("Culture cannot be null!!");
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localUserNameTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://127.0.0.1/",
                                        ...
                                        if (localCulture != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCulture));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("Culture cannot be null!!");
                                        }
                                    }
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Auth".equals(type)){
                                ...
                                return (Auth)_1._0._0._127.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://127.0.0.1/","Culture").equals(reader.getName())){
