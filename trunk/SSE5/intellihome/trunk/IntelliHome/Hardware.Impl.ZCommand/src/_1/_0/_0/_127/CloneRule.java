 ...
 */
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       CloneRule.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                ...
                if (localAuthTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"rule", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"rule");
                                        }
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://127.0.0.1/",
                                    ...
                                    elementList.add(localAuth);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://127.0.0.1/",
                                        ...
                                        if (localRule != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRule));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("rule cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static CloneRule parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CloneRule object =
                new CloneRule();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CloneRule".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CloneRule)_1._0._0._127.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
