 ...
 */
            ...
            /**
            *  SetWakeUpInterval bean class
            */
        
        public  class SetWakeUpInterval
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected org.apache.axis2.databinding.types.UnsignedInt localSeconds ;
                           ...
                           */
                           public  org.apache.axis2.databinding.types.UnsignedInt getSeconds(){
                               return localSeconds;
                           }
                            ...
                            /**
                               ...
                               * @param param Seconds
                               */
                               public void setSeconds(org.apache.axis2.databinding.types.UnsignedInt param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       SetWakeUpInterval.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SetWakeUpInterval",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SetWakeUpInterval",
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"seconds", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"seconds");
                                        }
                                        ...
                                        xmlWriter.writeStartElement("seconds");
                                          ...
                                          if (localSeconds==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("seconds cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSeconds));
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://127.0.0.1/",
                                    ...
                                    elementList.add(localAuth);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://127.0.0.1/",
                                        ...
                                        if (localSeconds != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSeconds));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("seconds cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static SetWakeUpInterval parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetWakeUpInterval object =
                new SetWakeUpInterval();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SetWakeUpInterval".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetWakeUpInterval)_1._0._0._127.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://127.0.0.1/","seconds").equals(reader.getName())){
