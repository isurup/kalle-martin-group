...
\begin{figure}[h]
	\centering
		\includegraphics[scale=1]{sortingByColorTemp}
...
\begin{figure}[h]
	\centering
		\includegraphics[scale=1]{efficiencyCalculation}
...
\begin{figure}[h]
	\centering
		\includegraphics[scale=1]{diagramInit}
...
\begin{figure}[h]
	\centering
		\includegraphics[scale=1]{diagramI}
	\caption{Diagram I}
	\label{fig:planning}
\end{figure}
...
\begin{figure}[h]
	\centering
		\includegraphics[scale=1]{diagramII}
	\caption{Diagram II}
	\label{fig:planning}
\end{figure}
...
\begin{figure}[h]
	\centering
		\includegraphics[scale=1]{diagramIII}
	\caption{Diagram III}
	\label{fig:planning}
\end{figure}
